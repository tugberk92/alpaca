...
cccccc example histogram      

      thetamin=dlog(1d-4)
      thetamax=dlog(1d0)
      
      call histo1(1,50,thetamin,thetamax,dlog(atheta),wt,'log(theta)')
...
ccc   prints histograms
   ...
   12 io(ih)=io(ih)+1
     ...
     &     Access='append',Status='old')
       ...
       write(10,*)'***************************************'
       write(10,*)lab(ih)(1:outl)
       write(10,*)'***************************************'
       write(10,*)'xmin : ',y0(ih)
       write(10,*)'xmax : ',y1(ih)
       write(10,21)ii(ih),iu(ih),io(ih)
       write(10,*)'***************************************'       
   ...
   25 if(iz.gt.0.and.iz.le.30) regel(iz)=star
      ...
      write(10,*)z,h(ih,iv)/bsize/dble(it)
